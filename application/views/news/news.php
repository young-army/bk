         ...
         <div class="container-fluid">
            ...
            <div class="">
                ...
                <div class="widget black">
					...
					<a href="<?php echo base_url();?>dashboard/add_news"><button class="btn btn-success"><i class="icon-plus icon-white" ></i> Tambah Data</button></a><br><br></style>
                        ...
                        <table class="table table-striped table-bordered" id="sample_1">
                            ...
                            <tr>
                                ...
                                <th class="hidden-phone">Sumber</th>
