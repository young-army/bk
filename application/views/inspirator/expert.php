            ...
            <div class="">
                ...
                <div class="widget black">
                    <div class="widget-title">
                        <h4><i class="icon-reorder"></i> Expert</h4>
                            
                    </div>
                    <div class="widget-body">
					<a href="<?php echo base_url();?>dashboard/tambah_data_expert"><button class="btn btn-success"><i class="icon-plus icon-white" ></i> Tambah Data</button></a><br><br></style>
                        ...
                        <table class="table table-striped table-bordered" id="sample_1">
                            ...
                            <tr>
                                ...
                                <th class="hidden-phone">Keahlian</th>
