            ...
            <div class="row-fluid">
                ...
                <div class="widget black">
                        <div class="widget-title">
                            <h4><i class="icon-reorder"></i> Career</h4>
                        ...
                        <div class="widget-body">
							...
							<div class="control-group">
                                ...
                                <div class="controls" style="text-align:left">
                                    <input type="radio" name="sub_menu" value="R" style="margin-top:-3px"> Right
                                    <input type="radio" name="sub_menu" value="L" style="margin-top:-3px"> Left
                                </div>
                            </div>
							<div class="control-group">
