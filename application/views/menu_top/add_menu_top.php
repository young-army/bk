                ...
                <div class="widget black">
                        ...
                        <div class="widget-body">
							...
							<div class="control-group">
                                ...
                                <div class="controls">
                                    <input type="text" class="span6 " name="menu"/>
                                </div>
                            </div>
							<div class="control-group">
							...
							<div class="control-group">
                                ...
                                <div class="controls">
                                    <input type="text" class="span6 " name="urut" style="width:100px"/>
                                </div>
                            </div>
							<div class="control-group">
                                <label class="control-label">File Background</label>
                                <div class="controls">
							...
							<div class="control-group">
                                ...
                                <div class="controls">
                                    <select class="span6 " name="kategori"/>
									<option></option>
									</select>
                                </div>
                            </div>
