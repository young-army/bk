            ...
            <div class="">
                ...
                <div class="widget black">
                    <div class="widget-title">
                        <h4><i class="icon-reorder"></i> Menu Top</h4>
                            
                    </div>
                    <div class="widget-body">
					<a href="<?php echo base_url();?>dashboard/add_menu_top"><button class="btn btn-success"><i class="icon-plus icon-white" ></i> Tambah Data</button></a><br><br></style>
                        ...
                        <table class="table table-striped table-bordered" id="sample_1">
                            ...
                            <tr>
                                <th>No</th>
                                <th class="hidden-phone">Menu</th>
                                <th class="hidden-phone">Urut</th>
