            ...
            <div class="">
                ...
                <div class="widget black">
                    <div class="widget-title">
                        <h4><i class="icon-reorder"></i> Innovation</h4>
                            
                    </div>
                    <div class="widget-body">
					<a href="<?php echo base_url();?>dashboard/add_innovation"><button class="btn btn-success"><i class="icon-plus icon-white" ></i> Tambah Data</button></a><br><br></style>
                        ...
                        <table class="table table-striped table-bordered" id="sample_1">
                            ...
                            <tr class="odd gradeX">
                               ...
                               <a href="<?php echo base_url();?>dashboard/delete_innovation/<?php echo $row->id;?>"onclick="return confirm('Apakah Anda Yakin?')"><button class="btn btn-small btn-danger"><i class="icon-remove icon-white"></i> Delete</button></a></td>
                            </tr>
							<?php $no++;}?>
                            </tbody>
                        </table>
