            ...
            <div class="">
                ...
                <div class="widget black">
                    <div class="widget-title">
                        <h4><i class="icon-reorder"></i> Background</h4>
                            
                    </div>
                    <div class="widget-body">
					<a href="<?php echo base_url();?>dashboard/add_background"><button class="btn btn-success"><i class="icon-plus icon-white" ></i> Tambah Data</button></a><br><br></style>
